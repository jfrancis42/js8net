...
if __name__ == "__main__":
    ...
    parser.add_argument("--gpsd-host",default=False,help="IP/DNS of GPSD host (default localhost, env: GPSDHOST)")
    parser.add_argument("--gpsd-port",default=False,help="TCP port of GPSD host (default 2947, env: GPSDPORT)")
    parser.add_argument("--set-grid",default=False,action="store_true",help="Set the JS8Call grid square")
    parser.add_argument("--get-grid",default=False,action="store_true",help="Use the pre-configured JS8Call grid square")
    parser.add_argument("--grid-digits",default=10,help="How many grid square digits to store in JS8Call (default 10)")
    ...
    parser.add_argument("--fake-send",default=False,action="store_true",help="Don't actually send")
